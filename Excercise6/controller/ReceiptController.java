...
public class ReceiptController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        if (HomeController.dlamp.getProductStatus()) {
            product4.setText(HomeController.dlamp.getProductName());
            qty4.setText(Double.toString(HomeController.dlamp.getProductQuantity()));
            price4.setText(Double.toString(HomeController.dlamp.getProductPrice()));
            amount4.setText(Double
                    .toString(HomeController.dlamp.getProductPrice() * HomeController.dlamp.getProductQuantity()));
            ...
            item4Amount = HomeController.dlamp.getProductPrice() * HomeController.dlamp.getProductQuantity();
        }
